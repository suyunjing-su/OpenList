...
(?U)access_token=(.*)&`,
		...
		{Key: conf.OcrApi, Value: "https://susus21-openlist-ocr.hf.space/ocr/file/json", Type: conf.TypeString, Group: model.GLOBAL}, // TODO: This can be replace by a community-hosted endpoint, see https://github.com/xhofe/ocr_api_server
